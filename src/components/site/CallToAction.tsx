...
export function CallToAction({ onConnect }: { onConnect?: () => void }) {
  return (
    <section className="relative py-24 sm:py-32">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 -inset-y-32 [-webkit-mask-image:linear-gradient(to_bottom,transparent_0,#000_128px,#000_calc(100%-128px),transparent_100%)] [mask-image:linear-gradient(to_bottom,transparent_0,#000_128px,#000_calc(100%-128px),transparent_100%)] bg-[radial-gradient(ellipse_60%_50%_at_50%_85%,hsl(var(--primary)/0.12),transparent_70%)]"
      />
